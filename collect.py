...
consumer_key = Config.get('twitterresearch', 'consumer_key')
consumer_secret = Config.get('twitterresearch', 'consumer_secret')
access_token = Config.get('twitterresearch', 'access_token')
access_token_secret = Config.get('twitterresearch', 'access_token_secret')
        ...
        for s in sampled:
            ...
            try:
                ...
                try: 
                    ...
                    try:
                        error.args[0][0]['message'] += '; Found by screen_name'
...
if __name__ == '__main__':
    ...
    ap.add_argument("--input-file", required=False, help="Specify tab-delimited file that has DOI, screen_name, DOIs to load")
